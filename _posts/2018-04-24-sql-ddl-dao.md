...
----:|---|---|---|---|---|---|---
DbutilDao|支持|支持|支持|支持|支持|未实现|sum, max, first, avg, count, count(distinct) ... 不支持: set, list
SolrDao|支持|支持单字段 java实现多字段|未实现|支持|支持|未实现|sum, max, first, avg, count, count(distinct) ... 不支持: set, list
