...
tags:  sybn-core dao sql mongo solr elastic mysql HBase 0.1.9
author: sybn
---
...
* 目前已经支持用其读写 mysql, mongodb, solr, elsatic,hbase 数据库，以及 java collection 和 stream ,并支持整合到 spring data / hibernate jpa 的查询框架.
